...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7__unpack_list( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7__unpack_list( PyObject **python_pars )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_7__unpack_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)tmp_list );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_12_complex_call_helper_pos_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_12_complex_call_helper_pos_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_9_complex_call_helper_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_9_complex_call_helper_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_11_complex_call_helper_pos_keywords_star_list_star_dict( PyObject **python_pars )
{
            ...
            }
            {
                ...
                branch_yes_7:;
                {
...

                    {
                        ...
                        tmp_tuple_element_4 = impl___internal__$$$function_3_get_callable_name_desc( dir_call_args );
                    }
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_11_complex_call_helper_pos_keywords_star_list_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_13_complex_call_helper_keywords_star_list( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_13_complex_call_helper_keywords_star_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_keywords_star_list_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_10_complex_call_helper_keywords_star_list_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
