...
class Ui_ZModulesWindowMain(object):
    def setupUi(self, ZModulesWindowMain):
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(20, 70, 171, 22))
        self.lineEdit_4.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_4.setStyleSheet("background-color: #2EE800;")
        self.lineEdit_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_5 = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_5.setGeometry(QtCore.QRect(210, 70, 171, 22))
        self.lineEdit_5.setStyleSheet("background-color: #2EE800;")
    ...
    def retranslateUi(self, ZModulesWindowMain):
        ...
        self.label_3.setText(_translate("ZModulesWindowMain", "Введите 2 целых числа:"))
        self.lineEdit_4.setText(_translate("ZModulesWindowMain", "0"))
        self.lineEdit_5.setText(_translate("ZModulesWindowMain", "0"))
        self.comboBox.setItemText(0, _translate("ZModulesWindowMain", "Сумма"))
        self.comboBox.setItemText(1, _translate("ZModulesWindowMain", "Разность"))
        self.comboBox.setItemText(2, _translate("ZModulesWindowMain", "Произведение"))
        self.comboBox.setItemText(3, _translate("ZModulesWindowMain", "Частное от деления"))
        self.comboBox.setItemText(4, _translate("ZModulesWindowMain", "Остаток от деления"))
