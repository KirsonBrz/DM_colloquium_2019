...
class Ui_Polinomial_Input(object):
    def setupUi(self, Polinomial_Input):
        ...
        self.label_5 = QtWidgets.QLabel(self.PModulesWindowInput)
        self.label_5.setGeometry(QtCore.QRect(10, 140, 381, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, Polinomial_Input):
        ...
        self.label_5.setText(_translate("Polinomial_Input", "Введите коэффициент 0"))
